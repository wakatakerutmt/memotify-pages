...
- Personally identifying information such as name, email, phone number, address
- Location data
- Contacts, photos, calendar, or other device data
- Advertising identifiers (IDFA / GAID) or similar tracking identifiers
- Usage logs, navigation logs, crash reports
...
- Reading streak and read history
- App preferences (language, etc.)

This data is removed when you uninstall the App or clear its data through your OS settings.

## 3. Information Processed via Third-Party Services
...
### 3.2 Purchase Management: RevenueCat
...
RevenueCat retains this information to verify purchases and to restore purchases on re-download. See RevenueCat's own privacy policy at [https://www.revenuecat.com/privacy](https://www.revenuecat.com/privacy).
...
The App does **not** track users across other apps or websites. It does not use the Advertising Identifier (IDFA). As a result, the iOS 14.5+ **ATT permission prompt is not shown**. This is by design and complies with Apple's privacy guidelines.
...
Local data is protected by the standard sandbox mechanisms of each OS. While your device is locked, data is protected by device-level encryption.
...
[日本語版](../privacy.ja/) ・ [Terms of Service](../terms.en/)
