---
layout: legal
title: Terms of Service — Memotify
lang: en
permalink: /legal/terms.en/
---
...
The App offers the following plans under "Memotify Pro":

- **Monthly subscription** (auto-renewable)
- **Yearly subscription** (auto-renewable)
- **Lifetime** (one-time purchase)

Current prices and terms are displayed on the in-app Paywall. Prices may vary by region and currency.

### 3.2 Auto-Renewable Subscriptions

The monthly and yearly plans are auto-renewable subscriptions:

- Your subscription will automatically renew for the same period unless you turn off auto-renewal at least 24 hours before the end of the current period.
- The renewal charge will be billed within 24 hours of the end of the current period.
- You can cancel anytime in **Settings → Apple ID → Subscriptions** (iOS) or **Google Play → Subscriptions** (Android).
- Cancellation takes effect at the end of the current billing period. Partial-period refunds are not provided.

### 3.3 Lifetime Plan

The lifetime plan is a one-time purchase and does not auto-renew. Lifetime users retain access to all Memotify Pro features for as long as the App continues to be offered.

### 3.4 Restore

Previous purchases can be restored by tapping "Restore purchases" in the App, or by reinstalling the App while signed in with the same Apple ID / Google account.
...
[日本語版](../terms.ja/) ・ [Privacy Policy](../privacy.en/)
